...
**被動 — 護國意志**: 每過幾秒加里歐下一次的普攻即可對範圍內敵人造成魔法傷害。

| 鍵 | 技能 | 說明 |
|----|------|------|
| Q | 征戰風暴 | 加里歐釋放兩道氣流，氣流匯聚之後形成一股隨著時間過去而造成傷害的旋風。 |
| W | 杜蘭德之盾 | 加里歐進入防禦狀態並降低跑速，解除後嘲諷並傷害周圍所有敵人。 |
| E | 光榮制裁 | 加里歐向後退並蓄力接下來的攻擊，接著向前衝刺並擊飛第一個撞到的敵方英雄。 |
| R | 英靈之門 | 加里歐指定一名友軍的位置為他的著陸點，並給予範圍內所有隊友一個魔法護盾。短暫延遲一段時間之後加里歐會降落至友軍原先的位置，擊飛範圍內所有敵人。 |
